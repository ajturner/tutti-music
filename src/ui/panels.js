...
// opened from the menu bar: Files (open, save, export), Compose (the open phrase or pattern, key, tracks), Sounds (preview,
...
export const PANELS = ['files', 'compose', 'sounds', 'connect', 'view'];
