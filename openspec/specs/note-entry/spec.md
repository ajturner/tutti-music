...
Every edit SHALL be undoable with Cmd+Z and redoable with Cmd+Shift+Z or Cmd+Y, up to 200 steps, restoring the pattern being edited. On Windows and Linux Ctrl replaces Cmd. Control and Option/Alt SHALL never be required as modifiers.
