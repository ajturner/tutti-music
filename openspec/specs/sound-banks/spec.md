...
The app SHALL bundle Jazz combo (piano, vibraphone, tenor sax, upright bass, drum kit), Folk group (fiddle, folk harp, recorder, harmonica, frame drum, hand percussion) and Electronica (FM piano, clavisynth, drum machine, lead, pad, pluck) built from CC0 sources, listed in a catalogue.

#### Scenario: Catalogue
- **WHEN** the user opens the Sounds panel
- **THEN** the three bundled banks are offered and can be loaded or unloaded
