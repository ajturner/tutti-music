...
The New button SHALL add an empty song titled "Untitled N" with default phrases and tracks and select it. The title field in the header SHALL rename the current song; an empty title becomes "Untitled".
