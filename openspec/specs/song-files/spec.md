...
### Requirement: Save
Save SHALL download the current song as pretty-printed JSON named after the title.
...
### Requirement: Load
Load SHALL read a JSON file, reject files without patterns and tracks with a status message, default a missing title to the file name, add the song to the list, and select it.
