...
### Requirement: Menu
The menu (≡, or Escape on a keyboard) SHALL offer Full view, New song, Save .json, Load .json and the song list, chosen with the pad; B SHALL close it. New song SHALL land on the Instrument level.
