...
- **Sound banks:** bundled Jazz combo, Folk group and Electronica banks, or any bank.json URL; add whole banks or single instruments; songs remember their banks. `npm run build:banks` regenerates them.
